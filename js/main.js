...
(function($) {
    ...
    const cfg = {
                ...
                mailChimpURL   : 'https://gmail.us1.list-manage.com/subscribe/post?u=31709e11cc2f635754cc2308c&amp;id=b57c1ece84' // mailchimp url
                };
    const $WIN = $(window);
    ...
    * ------------------------------------------------------ */
    const ssAjaxChimp = function() {
        ...
        $.ajaxChimp.translations.es = {
            'submit': 'Submitting...',
            0: '<i class="fas fa-check"></i> Thank you! you were subscribed succesfully!',
